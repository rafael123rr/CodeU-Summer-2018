 ...
 * @author Kefir
 */
final class BBProcessor extends TextProcessorAdapter {
    /**
     * BB-codes
     */
     ...
     */
    void setScope(Scope scope) throws IllegalStateException {
        if (this.scope == null) {
            this.scope = scope;
        } else {
     ...
     */
    void setPrefix(Template prefix) throws IllegalStateException {
        if (this.prefix == null) {
            this.prefix = prefix;
        } else {
